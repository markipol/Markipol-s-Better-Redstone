...
//
//public class FancyBlockBakedModel implements IDynamicBakedModel {
//
//	public static final ResourceLocation TEXTURE = new ResourceLocation(MarkisBetterRedstone.id, "block/fancy_block");
//
...
//	}
//
//	// usesBlockLight() is func_230044_c in MCP
//	@Override
...
//		BlockState mimic = extraData.getData(FancyBlockTE.MIMIC);
//		if (mimic != null && !(mimic.getBlock() instanceof FancyBlock)) {
//			if (layer != null || RenderTypeLookup.canRenderInLayer(mimic, layer)) {
//				IBakedModel model = Minecraft.getInstance().getBlockRenderer().getBlockModelShaper()
//				        .getBlockModel(mimic);
//				try {

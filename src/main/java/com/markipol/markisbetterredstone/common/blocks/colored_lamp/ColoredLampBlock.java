...
public class ColoredLampBlock extends Block{
	...
	public static final Property<Direction> DIRECTION_OF_UNCONNECTED_FACE = DirectionProperty.create("direction_of_unconnected_face", Direction.Plane.HORIZONTAL);
	...
	private BlockState getLampColourFromInputs(World world, BlockPos pos, BlockState state) {
		...
		return state
				.setValue(RED_INTENSITY, (int)Math.round(redIntensity))
